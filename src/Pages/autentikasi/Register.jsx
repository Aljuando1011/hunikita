    ...
    <div className="w-full h-screen flex item-start">
        ...
        <div className='w-1/2 h-full bg-[#FFFFFF] flex flex-col p-5 justify-between font-Poppins'>
            ...
            <div className='bg-white w-full px-6'>
                ...
                <h1 className='text-xl md:text-2xl text-blue-500 font-bold leading-tight mt-2'>Daftar</h1>
                    ...
                    <form className="mt-9" action="#" method="POST">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="password" minLength="10" placeholder="Masukkan sandi" className="w-full bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none rounded-lg" autoComplete autofocus required/>
                        </div>

                        <div className="mt-2">
                            <label className="font-semibold block text-gray-700">Konfirmasi Sandi</label>
                            <input type="password" minLength="10" placeholder="Masukkan sandi" className="w-full bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none rounded-lg" autoComplete autofocus required/>
                        </div>

                        <div class="mt-2">
                            <label className="font-semibold block text-gray-700">Daftar Sebagai</label>
                            <Dropdown/>
                            {/* <input type="text" placeholder="Pilih role" className="w-full bg-gray-200 border focus:border-blue-500 focus:bg-white focus:outline-none rounded-lg" required/> */}
                        </div>

                        <button className="w-full block bg-blue-500 hover:bg-blue-400 px-1.5 py-1.5 mt-5 rounded-lg font-semibold text-white font-Poppins focus:bg-blue-400 focus:outline-none mt-3" type="submit"><Link to="/Login">Daftar</Link></button>
